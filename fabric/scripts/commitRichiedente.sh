...
peer lifecycle chaincode commit -o $ORDERER_URL --ordererTLSHostnameOverride orderer-bacheca-com --channelID techchannel --name richiesta --version 1.0 --init-required --sequence 1 --tls true --cafile $ORDERER_CA --peerAddresses bigmarket-richiedente-bacheca-com:7051 --tlsRootCertFiles $BIGMARKET_RICHIEDENTE_CA --peerAddresses tech-forn1-bacheca-com:8051 --tlsRootCertFiles $TECH_FORN1_CA --peerAddresses tech-forn2-bacheca-com:10051 --tlsRootCertFiles $TECH_FORN2_CA
peer chaincode invoke -o $ORDERER_URL --ordererTLSHostnameOverride orderer-bacheca-com  --tls true --cafile $ORDERER_CA -C techchannel -n richiesta --peerAddresses bigmarket-richiedente-bacheca-com:7051 --tlsRootCertFiles $BIGMARKET_RICHIEDENTE_CA --peerAddresses tech-forn1-bacheca-com:8051 --tlsRootCertFiles $TECH_FORN1_CA --peerAddresses tech-forn2-bacheca-com:10051 --tlsRootCertFiles $TECH_FORN2_CA --isInit -c '{"function":"init","Args":[]}'
peer lifecycle chaincode commit -o $ORDERER_URL --ordererTLSHostnameOverride orderer-bacheca-com --channelID techchannel --name offerta --version 1.0 --collections-config /fabric/chaincode/bacheca/offerta/collections_configT.json --sequence 1 --tls true --cafile $ORDERER_CA --peerAddresses bigmarket-richiedente-bacheca-com:7051 --tlsRootCertFiles $BIGMARKET_RICHIEDENTE_CA --peerAddresses tech-forn1-bacheca-com:8051 --tlsRootCertFiles $TECH_FORN1_CA --peerAddresses tech-forn2-bacheca-com:10051 --tlsRootCertFiles $TECH_FORN2_CA

peer lifecycle chaincode commit -o $ORDERER_URL --ordererTLSHostnameOverride orderer-bacheca-com --channelID gardenchannel --name richiesta --version 1.0 --init-required --sequence 1 --tls true --cafile $ORDERER_CA --peerAddresses bigmarket-richiedente-bacheca-com:7051 --tlsRootCertFiles $BIGMARKET_RICHIEDENTE_CA --peerAddresses garden-forn1-bacheca-com:9051 --tlsRootCertFiles $GARDEN_FORN1_CA
peer chaincode invoke -o $ORDERER_URL --ordererTLSHostnameOverride orderer-bacheca-com  --tls true --cafile $ORDERER_CA -C gardenchannel -n richiesta --peerAddresses bigmarket-richiedente-bacheca-com:7051 --tlsRootCertFiles $BIGMARKET_RICHIEDENTE_CA --peerAddresses garden-forn1-bacheca-com:9051 --tlsRootCertFiles $GARDEN_FORN1_CA --isInit -c '{"function":"init","Args":[]}'
peer lifecycle chaincode commit -o $ORDERER_URL --ordererTLSHostnameOverride orderer-bacheca-com --channelID gardenchannel --name offerta --version 1.0 --collections-config /fabric/chaincode/bacheca/offerta/collections_configG.json --sequence 1 --tls true --cafile $ORDERER_CA --peerAddresses bigmarket-richiedente-bacheca-com:7051 --tlsRootCertFiles $BIGMARKET_RICHIEDENTE_CA --peerAddresses garden-forn1-bacheca-com:9051 --tlsRootCertFiles $GARDEN_FORN1_CA
